 ...
 * @author KHOA
 */
@WebServlet(name = "RemoveToCartStore", urlPatterns = {"/RemoveToCartStore"})
public class RemoveToCartStore extends HttpServlet {
